...
#include "TI_CC_CC1100-CC2500.h" //CC1100 register definitions
...
void TI_CC_Wait(volatile unsigned int cycles)
{
...
/* This part is selected for #define TI_Gxx*/
void TI_CC_SPISetup(void)
{
  TI_CC_CSn_PxOUT |= TI_CC_CSn_PIN;
  TI_CC_CSn_PxDIR |= TI_CC_CSn_PIN;         // /CS disable
...
void TI_CC_PowerupResetCCxxxx(void)
{
  ...
  /* Checking of stable system state after reset */
