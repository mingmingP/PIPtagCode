...
/* GPIP PORTS */
#if 0
// USCIA1 for 5529 proto with R.Martin's pins
#define TI_CC_SPI_USCIA1_PxSEL  P3SEL
#define TI_CC_SPI_USCIA1_PxDIR  P3DIR
#define TI_CC_SPI_USCIA1_PxIN   P3IN
#define TI_CC_SPI_USCIA1_SIMO   BIT3
#define TI_CC_SPI_USCIA1_SOMI   BIT4
#define TI_CC_SPI_USCIA1_PxSEL_UCLK  P2SEL
#define TI_CC_SPI_USCIA1_PxDIR_UCLK  P2DIR
#define TI_CC_SPI_USCIA1_UCLK   BIT7

// USCIB0 for F5529 Proto board
...
/* Added for TPIP Special function select */
