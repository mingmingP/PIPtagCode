...
//#define TI_CCxxx0_PATABLE      0x26		// -10dbm in 868 frequency band
#define TI_CCxxx0_PATABLE      0x3E	//Original value should be 0xC5 for +10dbm in 868 frequency band
...
/*
 *
 * Custom definitions written for InPoint/Pip tags.
 * Taken from CC1150 datasheet (SWRS037A)
 *
 */
// Packet Length (PKTCTRL0)
#define TI_CCxxx0_PKT_LEN_FIX	0x00		// Fixed packet length (set TI_CCxxx0_PKTLEN)
#define TI_CCxxx0_PKT_LEN_VAR	0x01		// Variable packet length
#define TI_CCxxx0_PKT_LEN_INF	0x02		// Infinite length packet

// Enable CRC
#define TI_CCxxx0_PKT_CRC_EN	0x04		// Enable 16-byte CRC after packet data

// Packet modes
#define TI_CCxxx0_PKT_FMT_NOR	0x00		// Normal packet mode
#define TI_CCxxx0_PKT_FMT_SSM	0x10		// Serial synchronous mode, data in on GDO0
#define TI_CCxxx0_PKT_FMT_RND	0x20		// Random mode, data in on PN9 generator
#define TI_CCxxx0_PKT_FMT_ATM	0x30		// Asynchronous transparent mode, data in on GDO0

// Data whitening
#define TI_CCxxx0_PKT_DAT_WHT	0x40		// Data whitening on
